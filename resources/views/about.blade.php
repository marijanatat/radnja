...
<head>
    ...
    {!!$map['js']!!}
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=eshop-282718&callback=initMap"
  type="text/javascript"></script>
{{-- <script async defer src="https://maps.googleapis.com/maps/api/js?key={{config('googlemap')['eshop-282718']}}&callback=initMap"
