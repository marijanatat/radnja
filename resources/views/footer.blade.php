...
@section('footer')
    ...
    <div class="w-full p-8"  style="background-color: rgb(20, 104, 107);padding-left:40px">
      ...
      <div class=" sm:w-1/3 h-auto sm:mt-0 mt-8 ml-12 md:ml-8">
        <div class="">
            <p class="text-center text-white text-base hover:text-gray-500 p-2 mr-24">Ovde nas možete pronaći:</p>
