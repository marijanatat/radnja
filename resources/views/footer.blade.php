...
<div class="container bg-grey-500 " >
  ...
  <div class="sm:w-1/3 h-auto">
      <ul class="list-reset leading-normal">
          <div class="flex items-center ">
              ...
              <a href=""><li class="text-xl sm:text-2xl xl:text-4xl text-blue-800 ml-2 font-semibold ">Mob-ing</li></a>
          </div>
  ...
  <div class="sm:w-1/3 h-auto ">
      ...
      <ul class="list-reset leading-normal mt-4 sm:mt-12 md:mt-16">
  ...
  <div class="sm:w-1/3 h-auto sm:mt-0 mt-8">
    <div class="">
        ...
        <iframe  class="w-64 h-56 md:w-96 md:h-64 pb-2" src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d1398.1260028649447!2d19.257321988241856!3d45.50500542734718!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ssr!2srs!4v1594243180190!5m2!1ssr!2srs"  frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
...
<div class= "bg-gray-800 text-white p-2" style="">
    <div class="flex justify-content-between items-center ">
        <p class=" text-sm  xs:text-xl ml-2 xl:ml-20">Designed &amp; Developed by: <a href="" class="text-blue-500">Bane </a><span class="text-blue-500">&</span><a href="" class=" text-blue-500"> Marijana</a></p>
        <p class=" mr-2 md:mr-20">Copyright © 2020 <a href="#" class="text-blue-500">Mob-ing</a>. Sva prava zadržana</p>
