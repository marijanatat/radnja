...
<div class="container">
    <div class="auth-pages mx-12 md:mx-32 my-1 md:my-16 grid-cols-1 lg:grid-cols-2">
        <div class="auth-left">
         ...
         <div class="auth-right  -ml-20 mr-2 md:mx-12 -mt-16 md:mt-4 mb-8 md:mb-8 border-none md:border:block" style="border-left: 1px solid $separator-color;" data-aos="fade-left"> 
            ...
            &nbsp;
            <div class="spacer hidden lg:block "></div>
            <p class="mt-10 lg:mt-0">Imate opciju i da kreirate svoj nalog</p>
            <div class="spacer"></div>
