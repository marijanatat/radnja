...
<div class="container text-gray-700 mx-1 md:mx-3 my-2 text-md xl:text-xl   p-2 md:p-2 w-full">
    <h2 class=" w-full text-gray-700 text-3xl px-5 font-bold leading-none  p-4 my-4 ">Otkazivanje porudžbine</h2>
  </div>
    
    <div class="w-full container text-gray-700 text-2xl px-5 pb-5 pt-2">
        Poštovani kupci, Obaveštavamo Vas da se prema Zakonu o zaštiti potrošača (Službeni glasnik RS, br. 6/2016) kupovina preko naše prodajne internet stranice www.mob-ing.rs smatra prodajom na daljinu.   
    </div>
